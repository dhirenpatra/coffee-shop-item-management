...
public class ProductWebClient {
    ...
    public static void main(String[] args) {
        ...
        productWebClient.addProduct()
                        ...
                        .take(1)
                        .flatMap(p -> productWebClient.updateProduct(p.getProductId(),
                                p.getProductName()+"Updated", p.getPrice().add(BigDecimal.valueOf(29999))))
                        .thenMany(productWebClient.getAllProducts())
    ...
    public Mono<ResponseEntity<Product>> addProduct() {
        return  webClient.post()
                        .body(Mono.just(new Product(null, "Nokia N16pro",
                                BigDecimal.valueOf(760.78))), Product.class)
                        .exchange()
